...
const HeroSection = () => {
    ...
    return (
        <div className="relative"
            ...
            <div className="pattern-background default-fade pointer-events-none"
                style={{ opacity: isHovering ? 0 : 0.3 }}></div>
            <div className="pattern-background pointer-events-none"
                style={{
            ...
            ></div>
            <div className="opacity-10 z-10 pointer-events-none">
            ...
            <div className="relative z-20">
                ...
                <div className="mt-5 gap-5 flex pointer-events-auto">
